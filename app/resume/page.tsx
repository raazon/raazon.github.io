					...
					<article id="resume" className="resume-wrapper mx-auto theme-bg-light p-5 mb-5 my-5 shadow-lg">
									...
									<section className="skills-section py-3">
										...
										<div className="item">
											...
											<ul className="list-unstyled resume-skills-list">
												<li className="mb-2">PHP/WordPress/REST APIs/MySQL</li>
												<li className="mb-2">Gutenberg/FSE/WP-CLI</li>
												<li className="mb-2">JavaScript/TypeScript/React</li>
												<li className="mb-2">HTML/CSS/SASS/Tailwind CSS</li>
												<li className="mb-2">Plugin/Theme Development</li>
												<li className="mb-2">NPM/Composer/Webpack/Gulp</li>
												<li className="mb-2">Git/GitHub Actions/CI/CD</li>
												<li className="mb-2">PHPUnit/PHPCS/Playwright</li>
						...
						<div className="resume-footer text-center">
							<ul className="resume-social-list list-inline mx-auto mb-0 d-inline-block text-muted">
								...
								<li className="list-inline-item mb-lg-0 me-3">
									<a className="resume-link text-decoration-none" href={siteConfig.links.github}>
										<Icon name="squareGithub" className="me-1" />
										<span className="d-none d-lg-inline-block text-muted">@github.com/raazon</span>
									</a>
								</li>
