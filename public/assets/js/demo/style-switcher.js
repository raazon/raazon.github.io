...
// Random Style
let randomStyle = Math.floor(Math.random() * 10) + 1;
themeStyleSheet.setAttribute('href', `assets/css/theme-${randomStyle}.css`);
colorOptionsContainer.children[randomStyle - 1].classList.add('active');
